...
**[12. Transactions](12.atomic-cascade-deletes.md).** Needs MongoDB running as a replica set. If you are on Atlas you already have one. If you are on a local standalone `mongod`, the setup is a genuine detour. Worth doing, since transactions are a concept you need, but do not let it block other work.
...
The core project. These three are heavily interlinked, so read all three before starting any of them. Together they close vulnerabilities `07`, `16`, and the client half of `03`.
...
**Previous:** [Vulnerabilities guide](../vulnerabilities/index.md) · **Next:** [01. Replace the fallback-value env helper with fail-fast validated config](01.fail-fast-env-config.md) · **Up:** [Audit index](../00.INDEX.md)
