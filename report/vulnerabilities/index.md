...
| [17](17.auth-middleware-ignores-account-status.md) account status | 1 hr | none | ★★☆ |
| [10](10.password-change-does-not-revoke-sessions.md) session revocation | 3 hrs | token versioning | ★★★★ |
| [19](19.dead-privilege-fields.md) dead fields | 30 min | none | ★★☆ |
...
**Previous:** [Priority ranking](../RANKING.md) · **Next:** [01. Hardcoded fallback JWT secrets](01.hardcoded-fallback-jwt-secrets.md) · **Up:** [Audit index](../00.INDEX.md)
